            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    <label htmlFor="med-img">
                        <img className='w-16 bg-gray-100 rounded-full cursor-pointer' src={medRepImg ? URL.createObjectURL(medRepImg) : assets.upload_area} alt="" />
                    </label>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Company</p>
                            <input onChange={(e) => setCompany(e.target.value)} value={company} className='border rounded px-3 py-2' type="text" placeholder="Company Name" required />
                        </div>

                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Territory</p>
                            <input onChange={(e) => setTerritory(e.target.value)} value={territory} className='border rounded px-3 py-2' type="text" placeholder="Territory/Region" required />
                        </div>

                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Employee ID</p>
                            <input onChange={(e) => setEmployeeId(e.target.value)} value={employeeId} className='border rounded px-3 py-2' type="text" placeholder="Employee ID" required />
                        </div>
                ...
                <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full'>Add Medical Rep</button>
            </div>
        </form>
    )
}
